...
const Maker = () => {
  ...
  const fetchMaker = async () => {
    try {
      ...
      const makerData = data.map((row) => ({
        id: row.id_maker,
        nama: row.nama,
      }));
      setAllData(makerData);
    } catch (error) {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto bg-gray-50 h-fit overflow-y-auto">
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h2 className="text-xl font-semibold text-gray-900">Maker</h2>
      ...
      {/* Edit Modal */}
      <Modal isOpen={showEditModal} onClose={closeAllModals} title="Edit Maker">
        <div className="p-6">
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Maker Name
        ...
        <div className="p-6">
          ...
          <div className="text-center mb-6">
            <p className="text-gray-700">
              Are you sure you want to delete the maker{" "}
